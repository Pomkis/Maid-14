...
uplink-syndicate-disabler-name = Дизейблер синдиката #Maid
uplink-syndicate-disabler-desc = Продвинутый дизейблер, созданный на основе прототипа Nanotrasen. Хоть ему и не хватает мощности, это компенсируется самозаряжающейся батареей. #Maid
